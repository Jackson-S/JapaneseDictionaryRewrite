...
import output.kanji.templates.HtmlClass.BADGE_BOX
import output.kanji.templates.HtmlClass.CONTEXT
import output.kanji.templates.HtmlClass.DEFINITIONS
import output.kanji.templates.HtmlClass.FIELD_INFORMATION
import output.kanji.templates.HtmlClass.HEADER_READING
import output.kanji.templates.HtmlClass.PART_OF_SPEECH_MARKER
import output.kanji.templates.HtmlClass.SENSE_INFORMATION
import output.kanji.templates.HtmlClass.SUB_HEADING
import output.kanji.templates.HtmlClass.TRANSLATION
...
object Stylesheet : OutputFile {
    ...
    override val fileName = "KanjiDictionary.css"
